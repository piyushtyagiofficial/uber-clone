    ...
    <h5
      ...
      <div className="flex gap-2 flex-col items-center justify-center">
        ...
        <button onClick={() => {
            ...
            }} className='bg-green-600 mt-5 w-full text-white font-semibold p-2 rounded-lg'>Confirm</button>
        <button onClick={() => {
            props.setConfirmRidePopupPanel(false)
            props.setRidePopupPanel(false)
        }} className='bg-red-500 text-white mt-1 w-full font-semibold p-2 rounded-lg'>Cancel</button>
